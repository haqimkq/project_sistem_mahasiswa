				...
				<form id="formprogramstudi" onSubmit={e => handleSubmit(e, type, editedData)}>
					<div className="wrap">
						<div className="formel">
							...
							<input name="nama" type="text" placeholder="e.g. D-III MTPD" required />
						</div>
						<div className="formel">
						...
						<div className="formel fulls">
							...
							<input name="sk_akreditasi" type="text" placeholder="e.g. 001/Poltektrans SDP Palembang" required />
						</div>
					</div>
